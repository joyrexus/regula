...
// Setup a guard evaluator for the `Pending` state as a transition actor.
const pendingEvaluator = fromTransition((evaluation, event: Event) => {
...
export const pendingGuardActor = createActor(pendingEvaluator);
